...
| A18 | Keyring restart, backup, and missing-key refusal | Automated for the Card 1 custody and loader slice | `cli/src/visitor.rs`, `cli/tests/visitor_keyring.rs`, `test/visitor_keyring_test.exs` |
