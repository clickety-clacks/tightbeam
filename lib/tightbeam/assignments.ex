defmodule Tightbeam.Assignments do
  ...
  @doc "Return final holder verdict kinds from every applicable independent review card."
  ...
  defp review_candidates(queryable, assignment_id, holder_key, open_only?) do
    ...
    |> Enum.map(fn [id, opened_at, holder, outcome, repo, oid, verdict, refs] ->
      %{
        id: id,
        opened_at: opened_at,
        holder_key: holder,
