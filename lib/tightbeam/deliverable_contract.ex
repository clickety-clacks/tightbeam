defmodule Tightbeam.DeliverableContract do
  ...
  @activation_shape "coordination-fabric-v1-phase1-v16"
  @current_shape "coordination-fabric-v1-phase1-v17"
  ...
  def ensure_schema(db \\ Tightbeam.DB) do
    case DB.query(db, "SELECT shape FROM schema_stamp") do
      {:ok, [[shape]]} when shape in [@activation_shape, @current_shape] ->
