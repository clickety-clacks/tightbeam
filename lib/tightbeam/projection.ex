defmodule Tightbeam.Projection do
  ...
  CREATE TABLE IF NOT EXISTS messages (
    ...
    markerTo               TEXT,
    CHECK (
      (messageType = 'marker' AND markerKind IS NOT NULL AND markerFrom IS NOT NULL AND markerTo IS NOT NULL)
      OR
      ((messageType IS NULL OR messageType <> 'marker') AND markerKind IS NULL AND markerFrom IS NULL AND markerTo IS NULL)
    )
  );
