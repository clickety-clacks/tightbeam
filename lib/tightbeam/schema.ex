defmodule Tightbeam.Schema do
  ...
  # Identity render stamps advance v9 to v10. The session projection amendment
  # then materializes mechanical status from its sole durable input and
  # advances v10 to v11.
  @shape "coordination-fabric-v1-phase1-v11"
  @session_mechanical_status_previous_shape "coordination-fabric-v1-phase1-v10"
