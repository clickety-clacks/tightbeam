defmodule Tightbeam.Wakes do
  ...
  CREATE TABLE IF NOT EXISTS wake_delivery_outcomes (
    ...
    failureClass TEXT CHECK
                   (failureClass IN ('could_not_run','run_failed','run_canceled','carrier_canceled',
                                     'outcome_unknown')),
  ...
  defp terminal_cause_id(opts, turn_seq), do: Map.get(opts, :wake_cause_id, "turn:#{turn_seq}")
