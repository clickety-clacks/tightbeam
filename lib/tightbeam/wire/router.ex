defmodule Tightbeam.Wire.Router do
  ...
  @non_target_verbs ~w(transcript turn-trace toplines topline coordination-share digest-members answer return work-item-bind-spec)
  ...
  defp error_status("spec_binding_conflict"), do: 409
