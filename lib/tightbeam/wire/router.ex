defmodule Tightbeam.Wire.Router do
  ...
  @non_target_verbs ~w(activation-declare activation-authority activation-attempt activation-observe activation-reconcile activation-withdraw activation-renotify activation-ack activation-status activations completion-notices completion-disposition transcript turn-trace execution-map execution-map-select toplines topline topline-create topline-update topline-close topline-reopen topline-link-work topline-unlink-work topline-concern-create topline-concern-update topline-concern-resolve topline-concern-reopen topline-concern-link-work topline-concern-unlink-work topline-work-leave-unlinked topline-placement-list coordination-share digest-members answer return operator-ask operator-rule operator-withdraw decision-request decision-requests)
