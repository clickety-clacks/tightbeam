defmodule Tightbeam.Wire.Router do
  ...
  get "/version" do
    ...
    json(conn, 200, %{
      ...
      "features" => ["activation-events-v1", "stale-turn-settlement-v1"],
      "adapters" => health
    })
  end
