defmodule Tightbeam.Wire.Router do
  ...
  @agent_verbs ~w(wake condition facts-read artifact-record artifact-get artifacts spawn retire critical inspect cancel tune approve-device deny-device revoke-device promote-user add-user config register-host host-env-set host-env-list host-env-unset update-clients identity-edit identity-status identity-relearn identity-repoint learn unlearn kungfu-list identity-apply kungfu-scaffold onboard role-create role-bind role-rm role-list assign dispatch assignment-get attest attests revoke-assignment reopen-assignment assignments work-item-create work-item-get work-item-trace work-item-list work-item-update work-item-icebox work-item-reopen work-item-close work-item-fail rule effort-rule waive revoke-waiver withdraw ask answer decision-requests decision-request transcript attend toplines topline coordination-share digest-members harness-processes processes process-open process-bind process-outcome process-get process-extend process-stop process-reconcile)
  ...
  @non_target_verbs ~w(transcript toplines topline coordination-share digest-members answer)
