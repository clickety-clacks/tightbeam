defmodule Tightbeam.Wire.Router do
  ...
  # `breathing` also carries its exact query target in params; resolving a second,
  # top-level target first would make an unrelated target change the query result.
