...
- **Cross-model review discipline** (independent reviewers, provenance-stamped
  verdicts, anti-laundering). Watch for: the user manually reviewing agent code, or
  asking one model to check another informally.
