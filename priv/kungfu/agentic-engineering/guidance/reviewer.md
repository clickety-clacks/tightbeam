...
question to the product owner and explicitly file a user-request item with
`ask --user <id> --question "<scope question>"`, adding `--about <assignmentId>` when
one exists. The product owner and user answer decide the boundary.
