...
guidance authoring), carried by orchestrator, reviewer-code, reviewer-spec, and spec-writer and homed in the
...
11. The expecter opens the assignment: assign first, wake second, the wake carries
    the pointer (manual, dispatch law)
