...
Activity table for this kungfu's work. Capsules and the reading rule (ordered minds;
blocked if none; end of list = floor; `any` = floorless) live in the substrate's
...
| Spec drafting (under rulings)                   | faithful composition               | sol[medium], opus[high], sonnet[high]                                                         |
| Spec adversarial review                         | hostile depth, hole-hunting        | sol[high], sol[xhigh] (xhigh whole-lattice), fable[high], opus[high]                        |
| Orchestration (flow, dispatch, tracking)        | reliability, judgment-on-facts     | sol[high], fable[high]; fable when contested                                     |
| Implementation — NEW patterns, critical code, tough bugs | architectural judgment while coding | sol[medium], opus[high], fable[high] when load-bearing |
...
| Code review of a review-required effect         | independent judgment + rigor       | sol[high], opus[high], fable[high]                                                |
