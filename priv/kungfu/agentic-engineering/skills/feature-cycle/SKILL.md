---
name: feature-cycle
description: Coordinate specialist handoffs, reviews and integration for a bounded objective. Load when arranging those transitions.
---
...
Link independent technical review to its producer. Use reviewer-spec for specifications and reviewer-code for implementation. Preserve the latest attributable review conclusion and the subject it covers. Before opening a code review, confirm the producer has filed the current passing-test receipt required by the existing admission rule. Preserve truthful verification and independent judgment on the resulting work. Use recon for a bounded diagnostic question when that is the useful assignment. Do not file producer completion to summon review.
