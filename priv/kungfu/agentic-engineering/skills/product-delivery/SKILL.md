...
description: Product-scope defaults for an orchestrator that owns a product's delivery.
---
...
When a lane closes, retire its owner unless the next lane can reuse its retained context.
