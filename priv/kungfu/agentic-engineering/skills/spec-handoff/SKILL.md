...
2. Open questions are listed explicitly in their own section, not buried in prose, each
   ...
   concept goes through the responsible owner for PO judgment and holds back the affected
...
owns product intent. Check gap-filling decisions against the current recorded judgment
and route intent questions through the responsible owner. Stay addressable: coders and reviewers reach you
...
change agreed product behavior, or require an authority decision, route it through the
responsible owner for PO judgment. Ask the user only for the choice that exceeds existing
authority, and incorporate the governing disposition. Either way: amend the canonical spec, re-bind the hash,
