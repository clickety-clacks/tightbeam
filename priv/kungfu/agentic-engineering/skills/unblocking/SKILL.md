...
Classify the evidence before you clear a block or authorize more of the same activity:
...
Stop authorizing more activity of the same class. Name the unchanged deliverable
boundary and choose a different next action or end the lane.
