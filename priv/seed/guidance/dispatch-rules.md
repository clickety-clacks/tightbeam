# Dispatch rules — the desk matrix (template)

Desks are cheap minds the org does not trust with substance, so their limits are
WALLS, not wisdom: never rely on a desk's judgment to know its own boundary. This
