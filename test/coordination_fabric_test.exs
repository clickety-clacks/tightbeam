defmodule Tightbeam.CoordinationFabricTest do
  ...
  test "THE TRIPWIRE: an open question gates nothing (fabric §10)", %{db: db} do
    ...
    pinned_arities = %{
      ...
      file_agent_request_in_txn: 2,
      settle_agent_request_in_txn: 4,
      answer_open: 4,
      return_open: 4,
      ...
      migrate_effort_deadline_ownership_v1_in_txn: 1,
      ...
      late_ruling_receipt_context_in_txn: 4,
      applicable_late_rulings_in_txn: 4,
