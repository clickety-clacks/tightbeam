defmodule Tightbeam.EffortCheckinTest do
  ...
  setup do
    ...
    main = Org.get(db, Org.personal_session_key("h1"))
  ...
  test "proofs 6, 11, 12, 13: expecter authority, self/user routing, deadlines and exact menu",
    ...
    # Rotate to H1. The cold-start claimant is the org admin, so the action menu
    # retains the administrative revoke and dispatch powers.
