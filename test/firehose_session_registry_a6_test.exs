defmodule Tightbeam.Firehose.SessionRegistryA6Test do
  ...
  test "carrier predecessor migration materializes status and advances every changed public item version" do
    ...
    :ok =
      DB.execute(
        ...
        INSERT INTO schema_stamp VALUES ('agent-decision-carrier-return-v1-019', 1);
    ...
    assert {:ok, [["session-mechanical-status-v1-019"]]} =
