defmodule Tightbeam.Firehose.SessionRegistryA6Test do
  ...
  test "v10 migration materializes status and advances every changed public item version" do
    ...
    :ok =
      DB.execute(
        ...
        INSERT INTO schema_stamp VALUES ('coordination-fabric-v1-phase1-v10', 1);
