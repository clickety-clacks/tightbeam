...
INSERT INTO schema_stamp VALUES('session-reparent-v1-019',1789250625552);
...
INSERT INTO causal_events_epoch VALUES(0,1789250625443);
CREATE TABLE users (
...
INSERT INTO decision_request_terminal_epoch VALUES(0,'terminal-operator-decision-parity-v1',0,1789250625506,'terminal-operator-decision-parity-v1','process:tightbeam');
...
CREATE TABLE sessions (
  ...
  createdAt     INTEGER NOT NULL,
  updatedAt     INTEGER NOT NULL
, mechanicalStatus TEXT NOT NULL
...
INSERT INTO topline_schema_stamp VALUES(1,'standalone-toplines-v5',1789250625504);
...
INSERT INTO supervision_liveness_epoch VALUES(0,1789250625506,'schema_activation','process:tightbeam');
