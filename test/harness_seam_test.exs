defmodule Tightbeam.HarnessSeamTest do
  ...
  test "Claude selection is owned by the installed client" do
    ...
    preset = Tightbeam.Harness.Claude.session_config(%{}, "")
    refute Map.has_key?(preset, :model_option_aliases)
    assert preset.canonical_model_prefixes == ["claude-"]
  end
end
